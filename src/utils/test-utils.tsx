 ...
 */
/**
 * Extended options for rendering components in tests, extending the default
 * RenderOptions by adding support for Redux store configuration and routing.
 *
 * @interface ExtendedRenderOptions
 * @extends {Omit<RenderOptions, "queries">}
 *
 * @property {Partial<RootState>} [preloadedState] - Defines a specific portion or the entire initial state for the Redux store.
 * This is particularly useful for initializing the state in a controlled manner during testing, allowing components to be rendered
 * with predetermined state conditions.
 *
 * @property {AppStore} [store] - Allows the use of a specific Redux store instance instead of a default or global store. This flexibility
 * is beneficial when testing components with unique store requirements or when isolating tests from a global store state. The custom store
 * should be configured to match the structure and middleware of the store used by the application.
 *
 * @property {string} [route] - Specifies the initial route for the component being tested. This is useful for testing components that rely
 * on specific routing conditions.
 */
...
interface ExtendedRenderOptions extends Omit<RenderOptions, "queries"> {
  ...
  /**
   * Specifies the initial route for the component being tested. This is useful
   * for testing components that rely on specific routing conditions.
   */
  route?: string
}
